...
<head>
    ...
    <link href="/common/vendor/datatables/dataTables.bootstrap4.min.css" rel="stylesheet">
   <style>
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary2 sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
                ...
                <div class="sidebar-brand-text mx-3"><img src="/common/img/logo-kurly-w.svg" style="background-position: center;background-size: cover;"/></div>
            </a>
            ...
            <li class="nav-item active">
                <a class="nav-link" href="/admmgr/main.do">
                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">지원자 점수 현황</h6>
                        </div>
                        <div class="card-body">
